    ...
    'en-US': [
      {
        ...
        description:
          'Discuss and Designed the Business Model based on the client’s requirement',
      },
      {
        title: 'ICO Website',
        description:
          'Customized website developing based on the customers business plan',
      },
      {
        title: 'Coin Whitepaper',
        description:
          'Issuing a white paper containing the motive, purpose, operation, and prospect of the coin',
      },
      {
        title: 'Coin Wallet',
        description: 'Web, Android, iOS application developing for Coin Wallet',
      },
      {
        title: 'Token Issuance',
        description: 'Token development using the latest blockchain technology',
      },
      {
        title: 'Marketing',
        description:
          'Marketing activities with the big communities and SNS channel',
      },
    ],
    'kr-KR': [
      {
        title: '사업 계획',
        description: '고객의 요구사항에 맞추어 비즈니스 모델 논의 및 설계',
      },
      {
        title: 'ICO 웹사이트 ',
        description: '사업 계획에 따른 맞춤형 코인 웹사이트 개발',
      },
      {
        title: '코인 백서 발간',
        description:
          '코인의 목적, 사용 계획, 운용 전략, 향후 전망 등이 포함된 백서 발간',
      },
      {
        title: '코인 지갑 개발',
        description: 'Web, Android, iOS 플랫폼에 맞는 코인 지갑 개발',
      },
      {
        title: '코인 발행',
        description: '최신 블록체인 기술을 사용한 코인 발행 및 시장 상장',
      },
      {
        title: '마케팅',
        description: 'SNS 및 코인 커뮤니티 채널을 활용한 마케팅 실행',
      },
    ],
  },
]
